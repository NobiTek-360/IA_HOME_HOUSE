...
---
 ...
 - Também inclui o Infer_NLU_cont_especializado.py, ele será usado para fazer a interferência do arquivo binário depois de treinar, ou também durante o treinamento, já que o sistema ele vai salvando a cada melhora do modelo um arquivo binário já pronto para uso.
